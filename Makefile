...
tlv : dazibao.o tlv_manager.o inondation.o neighbour.o hash_network.o data_manager.o hash.o maintain_neighbours.o
	$(CC) -o tlv dazibao.o tlv_manager.o inondation.o neighbour.o hash_network.o data_manager.o hash.o maintain_neighbours.o $(CRYPTO) $(PKGCONFIG) -std=gnu99
...
neighbour.o : neighbour.c neighbour.h
	$(CC) $(CFLAGS) -o neighbour.o -c neighbour.c -std=gnu99
